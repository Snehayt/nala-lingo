...
const PROJECT = 'da-express-milo';
const PLAYWRIGHT_PROJECT_SLUG = 'milo';
const ORG = 'adobecom';
...
module.exports = { PROJECT, PLAYWRIGHT_PROJECT_SLUG, ORG, BRANCHES, MAIN_BRANCH_LIVE_URL, STAGE_BRANCH_URL, BASE_URLS };
